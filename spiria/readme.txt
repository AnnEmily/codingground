...
This project will find all solutions by brute force to this question :

  "Given a vector of integers, find all combinations of operations
   (restricted to + - * /) between the numbers to reach a given target"
